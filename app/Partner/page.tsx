  ...
  return (
    <div className="container mx-auto  p-3">
      <div className="w-full py-5 pt-[100px] pb-[100px]" id="Partner">
        ...
        <div className="container px-3 mx-auto grid md:grid-cols-2 rid-cols-1">
          <div className="flex flex-col justify-center items-start text-center md:text-center">

            <div className="mx-auto p-5">
              <span className="leading-normal text-xl mb-8 text-justify ">
              ...
              <div className="w-full p-2 md:block lg:block" >
                <button
                  id="Machine/Equipment"
                  className={`mx-auto lg:mx-0 hover:bg-white sm:text-sm hover:text-blue-800 hover:shadow-xl hover:border-2 text-purple-900 font-bold my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out w-[300px] ${showHide === "yes"
                ...
                <button
                  ...
                  className={`mx-auto lg:mx-0 text-purple-900 font-bold sm:text-sm my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out w-[300px] ${showHide === "no"
                    ? "scale-105 bg-white text-blue-800 shadow-xl border-2"
                    : "bg-purple-200"
                    }`}
                  onClick={handleShow}
          ...
          <div className="py-6 text-center flex">
            <form
              onSubmit={handleSubmit(onSubmit)}
              className="shadow-2xl shadow-gray-600 w-full px-8 pt-6 pb-8 mb-4  mx-auto"
            >
