  ...
  return (
    <section className="py-14" id="Features">
      <div className="container mx-auto px-7 mt-12 h-full">
        <h2 className="w-full lg:text-6xl text-5xl mb-6 font-normal !leading-[60px] text-center">
          Features
        </h2>
        <div className="flex justify-center flex-wrap mt-24 align-middle">
          {Slider.map((items, ind) => (
            <div key={ind} className="lg:w-3/12 md:w-12/12 mb-4 p-5">
              <div className="w-full">
                <div className="flex w-full justify-start">
                  <div className="flex" style={{fontSize:"14px",fontWeight:"500",lineHeight:"21px"}}>{<items.icon />} <span className="ms-2 ps-2">{items.lable}</span></div>
                </div>
                <div className="mt-2"  style={{fontSize:"12px",fontWeight:"500",lineHeight:"14px"}}>
                {items.utlits}
                </div>
              </div>
            </div>
